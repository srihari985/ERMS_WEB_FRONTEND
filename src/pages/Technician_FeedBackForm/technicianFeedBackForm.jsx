                  ...
                  <Grid container spacing={2}>
                    ...
                    <Grid item xs={12} style={{ display: 'flex', justifyContent: 'flex-end' }}>
                      <Button
                        type="submit"
                        variant="contained"
                        style={{ padding: "10px 20px", backgroundColor:"#41CECA",width:"8%", color:'black', fontWeight:'bold', marginTop: '16px' }}
                  ...
                  <Grid container spacing={2}>
                    ...
                    <Grid item xs={12} style={{ display: 'flex', justifyContent: 'space-between' }}>
                      ...
                      <Button
                        type="submit"
                        variant="contained"
                        style={{ padding: "10px 20px", backgroundColor:"#41CECA",width:"13%", color:'black', fontWeight:'bold',marginTop: '16px' }}
...
export default TechnicianFeedbackForm;