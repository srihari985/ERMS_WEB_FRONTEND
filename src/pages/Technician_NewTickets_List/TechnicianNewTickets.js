...
const TechnicianNewTickets = () => {
  ...
  useEffect(() => {
    const fetchNewTickets = () => {
      ...
      const data = [
        { id: 1, ticketNo: 'T001', date: '2024-09-23', customername: 'John Doe', issues: 'Network issue', status: 'Open' },
        { id: 2, ticketNo: 'T002', date: '2024-09-24', customername: 'Jane Smith', issues: 'Hardware failure', status: 'Open' },
        { id: 3, ticketNo: 'T003', date: '2024-09-25', customername: 'Alan Walker', issues: 'Software bug', status: 'Open' },
      ];
      setTickets(data);
    };
    fetchNewTickets();
...
export default TechnicianNewTickets;